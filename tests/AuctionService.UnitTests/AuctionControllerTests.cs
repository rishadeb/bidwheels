...
public class AuctionControllerTests
{
    ...
    [Fact]
    public async Task GetAuctionById_WithValidGuidParams_ReturnsAuction()
    {
        // arrange
    ...
    [Fact]
    public async Task GetAuctionById_WithValidGuidParams_ReturnsNotFound()
    {
        // arrange
    ...
    [Fact]
    public async Task DeleteAuction_WithInvalidGui_Returns404Response()
    {
        // arrange
        var auction = _fixture.Build<Auction>().Without(x => x.Item).Create();
        auction.Seller = "test";
